...
const FixedNavigationBar = styled(CustomBox)`
  position: fixed;
  width: 420px;
  bottom: 0;
  left: 50;
		...
		>
			...
			>
				...
				>
					...
					<CustomFont $color={homeColor} $fontweight="bold">
						홈
					</CustomFont>
				</CustomButton>
				...
				>
					...
					<CustomFont $color={historyColor} $fontweight="bold">
						우체통
					</CustomFont>
				</CustomButton>
				...
				>
					...
					<CustomFont $color={myPageColor} $fontweight="bold">
						마이페이지
					</CustomFont>
				</CustomButton>
			</CustomRow>
